...
const criteria = [
  ...
  ["A custom non-native component", [["packages/dom/test/dom.test.mjs", "DOM view tokens can render arbitrary custom controls"], ["packages/react/test/react.test.mjs", "React field binding renders an opaque view"], ["packages/vue/test/vue.test.mjs", "Vue field binding renders an opaque view"], ["packages/angular/test/angular.test.mjs", "Angular signals follow controller snapshots"]]],
  ["The same core controller contract", [["packages/vue/test/vue.test.mjs", "Vue controller ownership watches controlled input"], ["packages/angular/test/angular.test.mjs", "Angular collection and wizard signals expose stable structural commands"]]],
