...
| `collections`, `collectionrules`, `collectionsort` | Collection command/property tests and React stable-row example |
| `wizard`, `dynamicsteps`, `stepsummaries`, `wizardnavigation` | Vanilla/React wizards and the wizard validation/navigation matrix |
...
| `quiz`, `slideshow`, `sparouter` | Application-owned composition over wizard bindings and named navigation events |
