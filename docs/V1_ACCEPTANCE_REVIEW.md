...
| AC-02 | Automated | Packed Node consumer imports all six packages without browser globals |
...
| AC-16 | Automated | DOM, React, Vue, and Angular opaque custom-view contracts |
| AC-17 | Automated | DOM, React, Vue, and Angular adapter proofs |
