...
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "GlobalErrorListeners" : "", { factory: () => {
...
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "Platform ID" : "", {
	providedIn: "platform",
	factory: () => "unknown"
});
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "AnimationModuleType" : "");
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "CSP nonce" : "", { factory: () => {
...
new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "IS_I18N_HYDRATION_ENABLED" : "");
new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "IS_EVENT_REPLAY_ENABLED" : "");
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "EVENT_REPLAY_QUEUE" : "", { factory: () => [] });
...
new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "IS_ENABLED_BLOCKING_INITIAL_NAVIGATION" : "");
...
var TemplateRef = class {
	...
	createEmbeddedViewImpl(context, injector, dehydratedView) {
		return new ViewRef(createAndRenderEmbeddedLView(this._declarationLView, this._declarationTContainer, context, {
...
var R3ViewContainerRef = class R3ViewContainerRef extends ViewContainerRef {
	...
	detach(index) {
		...
		return view && removeFromArray(getOrCreateViewRefs(this._lContainer), adjustedIdx) != null ? new ViewRef(view) : null;
	}
...
function ɵɵprojection(nodeIndex, selectorIndex = 0, attrs, fallbackTemplateFn, fallbackDecls, fallbackVars) {
	...
	setCurrentTNodeAsNotParent();
	const isNodeCreationMode = !lView[6] || isInSkipHydrationBlock();
...
var Component = makeDecorator("Component", (c = {}) => ({
	...
	...c
}), makeDecorator("Directive", (dir = {}) => dir, void 0, void 0, (type, meta) => compileDirective(type, meta)), void 0, (type, meta) => compileComponent(type, meta));
makeDecorator("Pipe", (p) => ({
	pure: true,
	...p
...
makePropDecorator("Output", (alias) => ({ alias }));
makePropDecorator("HostBinding", (hostPropertyName) => ({ hostPropertyName }));
...
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "compilerOptions" : "");
...
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "DefaultCurrencyCode" : "", { factory: () => USD_CURRENCY_CODE });
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "Translations" : "");
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TranslationsFormat" : "");
...
new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "STATE_CACHE_ACTIVE" : "");
...
var Query = class {};
makePropDecorator("ContentChildren", (selector, opts = {}) => ({
	selector,
	first: false,
	isViewQuery: false,
	descendants: false,
...
makePropDecorator("ContentChild", (selector, opts = {}) => ({
	selector,
	first: true,
	isViewQuery: false,
	descendants: true,
...
makePropDecorator("ViewChildren", (selector, opts = {}) => ({
	selector,
	first: false,
	isViewQuery: true,
	descendants: true,
...
makePropDecorator("ViewChild", (selector, opts) => ({
	selector,
	first: true,
	isViewQuery: true,
	descendants: true,
...
new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "REQUEST" : "", {
	providedIn: "platform",
	factory: () => null
});
...
new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "REQUEST_CONTEXT" : "", {
	providedIn: "platform",
	factory: () => null
});
...
function createPlatform(injector) {
	...
	if (typeof ngDevMode !== "undefined" && ngDevMode) registerAiTools();
...
//#endregion
//#region ../../packages/angular/dist/index.js
