...
const Select = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement(_Form.default.Group, {
    className: "mb-3",
    controlId: id
  }, label ? /*#__PURE__*/_react.default.createElement(_Form.default.Label, null, label, isRequired ? " *" : "") : null, prefix ? /*#__PURE__*/_react.default.createElement("span", null, prefix) : null, /*#__PURE__*/_react.default.createElement(_Form.default.Select, {
    "aria-label": "".concat(label).concat(isRequired ? " *" : ""),
    name: id,
    value: value,
    options: options,
    ...
    value: option.value,
    key: option.value
  }, option.text))), suffix ? /*#__PURE__*/_react.default.createElement("span", null, suffix) : null, secondaryText ? /*#__PURE__*/_react.default.createElement(_Form.default.Text, {
