...
const Stages = _ref => {
  ...
  const [activeChildren, setActiveChildren] = (0, _react.useState)([]);
  const [errors, setErrors] = (0, _react.useState)({});
  const [currentStep, setCurrentStep] = (0, _react.useState)(initialStep || 0);
  const [keys, setKeys] = (0, _react.useState)([]); // Todo: Keys need a isHidden property so we can hide steps correctly!
  ...
  */
  ...
  (0, _react.useEffect)(() => {
    ...
    setActiveChildren(children.map((item, index) => item({
...
Stages.propTypes = {
  children: _propTypes.default.arrayOf(_propTypes.default.oneOfType([_propTypes.default.node, _propTypes.default.func])).isRequired,
  ...
  validateOnStepChange: _propTypes.default.bool
};
Stages.defaultProps = {
  initialData: {},
