  ...
  return (
    <div style={{ padding: "16px 12px", backgroundColor: "#fff" }}>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <div style={{ fontSize: "12px", color: "#999999", lineHeight: "25px" }}>
          {store.generalConfig.status}
        </div>
      ...
      <div>
        <span style={{ color: "#5AA510" }}>fredi-bach</span>.
        <span style={{ color: "#C10B99" }}>{store.generalConfig.slug}</span>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <div>
