const WinzardNavButton = ({
  ...
  return (
    <a
      ...
      onClick={onClick}
      style={
        isStepDisabled(fieldKey, hash, disableIfActive)
          ? Object.assign({}, mainStyles, {
              color: "#bbb",
              pointerEvents: "none",
            })
          : Object.assign({}, mainStyles)
          ...
          config.stages.map((stage) => {
            ...
            return (
              <li
                ...
                key={`#${fieldKey}.${stage.id}`}
              >
                <WinzardNavButton
                  fieldKey={fieldKey}
                  hash={stepHash}
                  onClick={() => onNav("step", fieldKey, stage.id)}
                  isActive={isStepActive(fieldKey, stage.id)}
                  isStepDisabled={isStepDisabled}
                >
                  {stage.label}
                </WinzardNavButton>
