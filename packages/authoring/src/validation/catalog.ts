...
import type { StudioValidatorSpec } from "../document/types.js";
...
import type { StudioAsyncServiceBindings, StudioAsyncServiceResult } from "../registry/services.js";
import { resolveStudioMessage, type StudioLocalizationOptions } from "../localization/index.js";
